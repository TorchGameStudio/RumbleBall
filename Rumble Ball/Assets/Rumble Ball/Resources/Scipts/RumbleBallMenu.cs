// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RumbleBallMenu.cs" company="Exit Games GmbH">
...
public class RumbleBallMenu : MonoBehaviour
{
    ...
    public static readonly string SceneNameMenu = "RumbleBallMenu";

    public static readonly string SceneNameGame = "RumbleBallGame";
